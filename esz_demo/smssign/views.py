...
#
        ...
        contr_name = '/var/www/html/esz_demo/esz_demo/static/tmpls/htmltplcontracts/%s.html' % (userzign)
        with open (contr_name, 'w') as f: f.write(new_data)
        pdfkit.from_url('/var/www/html/esz_demo/esz_demo/static/tmpls/htmltplcontracts/%s.html' % (userzign), '/var/www/html/esz_demo/esz_demo/static/tmpls/out.pdf')
